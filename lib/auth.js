      ...
      sendResetPassword: async ({ user, url }) => {
        try {
          ...
          await sendTrackedEmail({
            ...
            to: user.email,
            subject: 'Restablecer contraseÃ±a â€” Tableo',
            html: `
              <p>Hola,</p>
              <p>Haz clic en el siguiente enlace para restablecer tu contraseÃ±a. Caduca en 1 hora.</p>
      ...
      sendVerificationEmail: async ({ user, url }) => {
        try {
          ...
          await sendTrackedEmail({
            ...
            html: `
              <p>Hola ${user.name},</p>
              <p>Haz clic aqui para verificar tu direccion de email:</p>
              <a href="${verificationLink}" style="background:#4f46e5;color:#fff;padding:10px 20px;border-radius:8px;text-decoration:none;">
                Verificar email
              </a>
            `,
            },
